import { BasicRepDetails, ConsensusStats, DistributionStats, Quorum, Supply } from '../../types';
...
export const calcDistributionStats = (supply: Supply): DistributionStats => ({
...
export const calcConsensusStats = (reps: BasicRepDetails[], supply: Supply, quorum: Quorum): ConsensusStats => {
    const allReps = {
